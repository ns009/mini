...
wget -O editdropbear "https://raw.githubusercontent.com/ns009/mini/main/portdb.sh"
wget -O editstunnel4 "https://raw.githubusercontent.com/ns009/mini/main/portssl.sh"
chmod +x menu
chmod +x usernew
chmod +x member
chmod +x deluser
